...
AL_API ALvoid AL_APIENTRY alSourceSetBufferCallback(ALuint source, void(*cbBufferPlayed)(void*), void *pParam)
{
	ALCcontext *Context;
	ALsource   *Source;
	...
	al_try
    {
		...
		Source->cbBufferPlayed = cbBufferPlayed;
		Source->pCallbackParam = pParam;
